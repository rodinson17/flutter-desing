...
var recentCourses = [
  Course(
    courseTitle: "Flutter para diseñadores",
    courseSubtitle: "12 secciones",
  ...
  Course(
    courseTitle: "Creación de prototipos",
    courseSubtitle: "10 secciones",
    background: LinearGradient(
      begin: Alignment.topLeft,
      end: Alignment.bottomRight,
      colors: [
  ...
  Course(
    courseTitle: "Cree una aplicación con SwiftUI",
    courseSubtitle: "22 secciones",
    background: LinearGradient(
      begin: Alignment.topLeft,
      end: Alignment.bottomRight,
      colors: [
...
var exploreCourses = [
  Course(
    courseTitle: "Aplicaciónes con SwiftUI",
    courseSubtitle: "22 secciones",
    background: LinearGradient(
      begin: Alignment.topLeft,
      end: Alignment.bottomRight,
...
var continueWatchingCourses = [
  Course(
    courseTitle: "React para diseñadores",
